...
public class DealActivity extends AppCompatActivity {
    ...
    //write to the database when the user clicks on save menu
        ...
        if (requestCode == PICTURE_RESULT && resultCode == RESULT_OK){
           ...
           /* ref.putFile(imageUri).addOnSuccessListener(this, new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    //This will contain the uri of the file that we successfully uploaded & will add it to the database
    ...
    private void saveDeal() {
        ...
        //choose whether this deal is new or an existing one, if exist update other wise its new
        if (deal.getId() == null) {
    ...
    private void deleteDeal() {
        if (deal == null) {
            Toast.makeText(this, "Please save the deal before the deleting", Toast.LENGTH_SHORT).show();
            return;
        }
